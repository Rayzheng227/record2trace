...
_SCENARIOINFO.fields_by_name['end_point'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINT2D
...
_HMISTATUS_GLOBALCOMPONENTSENTRY.fields_by_name['value'].message_type = modules_dot_common__msgs_dot_monitor__msgs_dot_system__status__pb2._COMPONENT

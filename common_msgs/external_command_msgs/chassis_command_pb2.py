...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_protobuf_dot_any__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_basic__msgs_dot_vehicle__signal__pb2.DESCRIPTOR,])
...
_CHASSISCOMMAND.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_CHASSISCOMMAND.fields_by_name['basic_signal'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_vehicle__signal__pb2._VEHICLESIGNAL

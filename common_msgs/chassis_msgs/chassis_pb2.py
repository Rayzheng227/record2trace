...
_CHASSIS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='custom_status', full_name='apollo.canbus.Chassis.custom_status', index=37,
...
_CHASSIS.fields_by_name['custom_status'].message_type = google_dot_protobuf_dot_any__pb2._ANY
